export const Config = Object.freeze({
  ...
  customerMessage(orderId, status, cancelReason = '') {
    ...
    const msgs = {
      ...
      pending: `✨ <b>تم استلام طلبك بنجاح</b> ✨\n\n📦 رقم الطلب: #${shortId}\n\nشكراً لاختيارك "الشاطر". سيتم تجهيز طلبك قريباً جداً. 🚀`,
      ...
      ready: `✨ <b>تحديث طلبك من الشاطر</b> ✨\n\n✅ طلبك #${shortId} جاهز الآن!\n\nطلبك أصبح جاهزاً بانتظار المندوب لاستلامه وتوصيله إليك. 📦`,
